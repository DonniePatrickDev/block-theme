 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Organic Rialto
...
add_action( 'tgmpa_register', 'organic_rialto_register_required_plugins' );

if ( ! function_exists( 'organic_rialto_register_required_plugins' ) ) {
	 ...
	 */
	function organic_rialto_register_required_plugins() {
		/*
		...
		if ( defined( 'IS_ATOMIC' ) && IS_ATOMIC && defined( 'ATOMIC_CLIENT_ID' ) && '2' === ATOMIC_CLIENT_ID ) { // WP.com recomended plugins conditional.
			$plugins = array(
				...
				array(
					'name'     => 'YITH WooCommerce Wishlish',
		 ...
		 */
		$config = array(
			'id'           => 'organic-rialto',          // Unique ID for hashing notices for multiple instances of TGMPA.
