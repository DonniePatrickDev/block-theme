(function (blocks, editor, components, i18n, element) {
  ...
  // Register Block.
  const organicWidgetBlock = blocks.registerBlockType('obb/widget-area-block', {
    title: __('Widget Area', 'obb'),
    description: __('Add a Widget Area anywhere in your page/post.', 'obb'),
    icon: widgetIcon,
    ...
    edit: function (props) {
      ...
      var inputButtonText = __('Save', 'obb')
      var desccontent = __('Enter a name for the Widget Area, then enter the Customizer to add Widgets.', 'obb')

      if (widgetAreaTitle && widgetAreaTitle !== '') {
        inputButtonText = __('Update', 'obb')
        desccontent = __('Enter the Customizer to add Widgets to this area.', 'obb')
      }
      ...
      var Header = el('div',
        ...
        el('h4',
          {
            className: 'obb-setup-title components-placeholder__label'
          },
          __('Widget Area', 'obb')
        ),
        el('p',
      ...
      var InputButtons = el('div',
        {
          className: 'obb-setup-form components-placeholder__fieldset'
        },
        el('input', {
      ...
      var customizerBtnTxt = __('Customizer View', 'obb')
      ...
      return [
        el('div',
          ...
          el('div',
            {
              className: 'obb-setup components-placeholder is-large'
            },
            Header,
            InputButtons,
            CustomizerButton
